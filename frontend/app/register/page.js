...
export default function Register() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[85vh] bg-background py-12">
      <div className="bg-[#111113]/40 p-10 shadow-2xl w-full max-w-md border border-white/5 rounded-3xl glass-panel border-t-4 border-t-gold">
        <h2 className="text-3xl font-extrabold mb-8 text-center text-white uppercase tracking-wider">Register</h2>
